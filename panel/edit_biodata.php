...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="left">Nomor Pendaftaran:</td>
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="left">Pekerjaan Ayah:</td>
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="left">Pekerjaan Ibu:</td>
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="left">Fc Raport:</td>
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="left">Status Hapus:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="left">Status Sah:</td>
      <td><input type="checkbox" name="status_sah"  <?php if (!(strcmp(htmlentities($row_ppdb_biodata['status_sah'], ENT_COMPAT, 'utf-8'),""))) {echo "checked=\"checked\"";} ?> /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="left">Status Terima:</td>

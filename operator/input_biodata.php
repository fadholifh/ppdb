...
?>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tanggal_lahir" value="" size="32" placeholder="YYYY-MM-DD" /></td>
    </tr>
    <tr valign="baseline">
...
?>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="asal_sekolah" value="" size="32" placeholder="SMPN 1 xxx" /></td>
    </tr>
    <tr valign="baseline">
